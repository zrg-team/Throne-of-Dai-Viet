...
description: "Use this skill when loading assets in Phaser 4. Covers the Loader plugin, loading images, spritesheets, atlases, audio, JSON, tilemaps, bitmap fonts, and tracking load progress. Triggers on: preload, this.load, asset loading, spritesheet, atlas, load progress. (Phaser 4.2.1 engine reference, vendored from node_modules/phaser/skills/loading-assets — do not edit; run `yarn skills`.)"
---
