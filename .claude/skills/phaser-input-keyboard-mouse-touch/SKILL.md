...
description: "Use this skill when handling user input in Phaser 4. Covers keyboard keys, mouse clicks and movement, touch events, pointer handling, drag and drop, hit areas, interactive objects, and gamepad support. Triggers on: keyboard, mouse, touch, pointer, drag, drop, click, input, gamepad, cursor keys. (Phaser 4.2.1 engine reference, vendored from node_modules/phaser/skills/input-keyboard-mouse-touch — do not edit; run `yarn skills`.)"
---
