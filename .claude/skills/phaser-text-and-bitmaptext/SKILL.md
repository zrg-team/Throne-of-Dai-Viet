...
description: "Use this skill when displaying text in Phaser 4. Covers Text game objects, BitmapText, web fonts, text styling, word wrap, alignment, padding, and dynamic text content. Triggers on: Text, BitmapText, this.add.text, font, word wrap, text style. (Phaser 4.2.1 engine reference, vendored from node_modules/phaser/skills/text-and-bitmaptext — do not edit; run `yarn skills`.)"
---
