---
name: phaser-tweens
description: "Use this skill when animating properties over time in Phaser 4. Covers tweens, tween chains, easing functions, stagger, yoyo, repeat, callbacks, number tweens, and the TweenManager. Triggers on: tween, ease, animate, this.tweens.add, tween chain, stagger. (Phaser 4.2.1 engine reference, vendored from node_modules/phaser/skills/tweens — do not edit; run `yarn skills`.)"
---
