...
description: "Use this skill when adding audio or sound to a Phaser 4 game. Covers loading audio, playing sounds, music, volume, spatial audio, Web Audio API, and SoundManager. Triggers on: sound, audio, music, volume, mute. (Phaser 4.2.1 engine reference, vendored from node_modules/phaser/skills/audio-and-sound — do not edit; run `yarn skills`.)"
---
