...
description: "Use this skill when creating particle effects in Phaser 4. Covers ParticleEmitter, emission zones, death zones, particle properties, textures, gravity wells, and particle movement. Triggers on: particles, emitter, particle effect, explosion, fire, smoke. (Phaser 4.2.1 engine reference, vendored from node_modules/phaser/skills/particles — do not edit; run `yarn skills`.)"
---
