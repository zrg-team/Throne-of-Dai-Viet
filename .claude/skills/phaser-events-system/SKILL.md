...
description: "Use this skill when working with the Phaser 4 event system. Covers EventEmitter, scene events, game events, custom events, and event-driven communication. Triggers on: events, on, emit, EventEmitter, scene events, listeners. (Phaser 4.2.1 engine reference, vendored from node_modules/phaser/skills/events-system — do not edit; run `yarn skills`.)"
---
