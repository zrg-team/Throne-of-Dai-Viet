...
description: "Use this skill when using Arcade Physics in Phaser 4. Covers enabling physics, velocity, acceleration, gravity, collisions, overlap, world bounds, physics groups, static bodies, and collision categories. Triggers on: physics, arcade, velocity, gravity, collide, overlap, bounce, physics body. (Phaser 4.2.1 engine reference, vendored from node_modules/phaser/skills/physics-arcade — do not edit; run `yarn skills`.)"
---
