...
description: "Use this skill when creating or controlling sprite animations in Phaser 4. Covers spritesheets, atlases, AnimationManager, AnimationState, play/stop/chain, frame callbacks, and animation events. Triggers on: sprite animation, spritesheet, play animation, animation frames. (Phaser 4.2.1 engine reference, vendored from node_modules/phaser/skills/animations — do not edit; run `yarn skills`.)"
---
