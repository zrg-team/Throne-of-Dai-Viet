...
description: "Use this skill when using timers and time-based events in Phaser 4. Covers TimerEvent, delayed calls, looping timers, the Clock plugin, and time scaling. Triggers on: timer, delay, delayedCall, TimerEvent, Clock, time event. (Phaser 4.2.1 engine reference, vendored from node_modules/phaser/skills/time-and-timers — do not edit; run `yarn skills`.)"
---
