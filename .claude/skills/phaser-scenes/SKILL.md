---
name: phaser-scenes
description: "Use this skill when working with Phaser 4 scenes. Covers scene lifecycle methods, scene transitions, parallel scenes, scene communication, sleeping, pausing, restarting, and the SceneManager. Triggers on: Scene, scene lifecycle, preload, create, update, scene transition, SceneManager. (Phaser 4.2.1 engine reference, vendored from node_modules/phaser/skills/scenes — do not edit; run `yarn skills`.)"
---
