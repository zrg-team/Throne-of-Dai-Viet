...
description: "Use this skill when working with Phaser 4 utility functions, actions, alignment, grid layout, or batch operations on game objects. Triggers on: align, grid layout, actions, set operations on groups of game objects. (Phaser 4.2.1 engine reference, vendored from node_modules/phaser/skills/actions-and-utilities — do not edit; run `yarn skills`.)"
---
