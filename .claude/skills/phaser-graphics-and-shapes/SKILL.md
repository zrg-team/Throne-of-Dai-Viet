...
description: "Use this skill when drawing shapes and graphics in Phaser 4. Covers the Graphics game object, lines, rectangles, circles, arcs, polygons, gradients, fill, stroke, and generated textures. Triggers on: Graphics, draw shape, fillRect, lineStyle, polygon, arc. (Phaser 4.2.1 engine reference, vendored from node_modules/phaser/skills/graphics-and-shapes — do not edit; run `yarn skills`.)"
---
