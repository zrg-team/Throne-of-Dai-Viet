...
description: "Use this skill when creating Sprites or Images in Phaser 4. Covers factory methods, texture/frame selection, position, scale, rotation, tint, flip, alpha, origin, depth, and the component mixin system. Triggers on: Sprite, Image, this.add.sprite, this.add.image, texture, setTint, setAlpha. (Phaser 4.2.1 engine reference, vendored from node_modules/phaser/skills/sprites-and-images — do not edit; run `yarn skills`.)"
---
