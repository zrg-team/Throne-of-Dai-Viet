---
name: phaser-cameras
description: "Use this skill when working with cameras in Phaser 4. Covers camera effects (shake, fade, flash, pan, zoom), following sprites, scroll, bounds, viewports, multiple cameras, and minimap. Triggers on: camera, viewport, scroll, zoom, follow, shake, fade. (Phaser 4.2.1 engine reference, vendored from node_modules/phaser/skills/cameras — do not edit; run `yarn skills`.)"
---
