...
export const enCore = {
  ...
  "menu.birds": "BIRDS",
  "menu.sounds": "SOUND",
  "menu.musicCredit": "Music: Scott Buckley (CC-BY 4.0) · Hanoi recordings by kevp888, freesound.org (CC-BY 4.0) · hitctrl, marcelofg55, opengameart.org (CC-BY 3.0)",
  ...
  // than none.
  "menu.install.tip": "Install the game to your home screen",
  ...
  "menu.install.iosSafari.step1": "Tap the Share button at the bottom of Safari.",
  "menu.install.iosSafari.step2": "Scroll down and choose “Add to Home Screen”.",
  "menu.install.iosSafari.step3": "Tap Add. Vạn Thắng lands beside your other apps.",
  "menu.install.iosOther.step1": "Tap the Share button in this browser.",
  "menu.install.iosOther.step2": "Choose “Add to Home Screen”.",
  "menu.install.iosOther.step3": "If it is not there, open this page in Safari and try again.",
  "menu.install.android.step1": "Open the browser menu (⋮ in the corner).",
  "menu.install.android.step2": "Choose “Install app”, or “Add to Home screen”.",
  "menu.install.android.step3": "Confirm. Vạn Thắng lands in your app drawer.",
  "menu.install.desktop.step1": "Look in the address bar for the install icon.",
...
export const viCore = {
  ...
  "menu.musicCredit": "Nhạc: Scott Buckley (CC-BY 4.0) · thu âm Hà Nội của kevp888, freesound.org (CC-BY 4.0) · hitctrl, marcelofg55, opengameart.org (CC-BY 3.0)",
  ...
  "menu.install.iosSafari.step1": "Chạm nút Chia sẻ ở cuối trình duyệt Safari.",
  "menu.install.iosSafari.step2": "Kéo xuống, chọn “Thêm vào MH chính”.",
  "menu.install.iosSafari.step3": "Chạm Thêm. Vạn Thắng nằm cạnh các ứng dụng khác.",
  "menu.install.iosOther.step1": "Chạm nút Chia sẻ trong trình duyệt này.",
  "menu.install.iosOther.step2": "Chọn “Thêm vào MH chính”.",
  "menu.install.iosOther.step3": "Nếu không thấy, hãy mở trang này bằng Safari rồi làm lại.",
  "menu.install.android.step1": "Mở menu trình duyệt (dấu ⋮ ở góc).",
  "menu.install.android.step2": "Chọn “Cài ứng dụng”, hoặc “Thêm vào màn hình chính”.",
  "menu.install.android.step3": "Xác nhận. Vạn Thắng nằm trong ngăn ứng dụng.",
  "menu.install.desktop.step1": "Tìm biểu tượng cài đặt trên thanh địa chỉ.",
