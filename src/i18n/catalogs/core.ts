...
export const enCore = {
  ...
  "menu.support.subtitle": "Mandate of Đại Việt is free, has no ads, and is made after hours. A coffee keeps the ink flowing.",
  ...
  "reason.needRiver": "Needs a river to hold back.",
  ...
  "msg.flood": "The river takes {land}. A third of the year's grain is gone — but the silt it leaves will pay some of it back.",
  "msg.drought": "The dry season bites in {land}. Without a reservoir the paddy goes thirsty.",
...
export const viCore = {
  ...
  "menu.support.subtitle": "Mandate of Đại Việt miễn phí, không quảng cáo, được làm ngoài giờ. Một ly cà phê giúp mực còn chảy.",
  ...
  "reason.needRiver": "Cần có sông để đắp đê.",
  ...
  "msg.flood": "Sông cuốn {land}. Mất một phần ba lúa cả năm — nhưng phù sa để lại sẽ bù phần nào.",
  "msg.drought": "Mùa khô cắn vào {land}. Không có hồ trữ, ruộng lúa khát nước.",
