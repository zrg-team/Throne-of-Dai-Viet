...
export const enCore = {
  ...
  "menu.resume.body": "Your run was written down the moment you left ({note}). Pick it up where it stopped, or leave it on the Continue line for later.",
...
export const viCore = {
  ...
  "menu.resume.body": "Ván chơi đã được ghi lại ngay lúc bạn rời đi ({note}). Chơi tiếp từ chỗ dừng, hoặc để lại ở dòng Tiếp tục cho lần sau.",
