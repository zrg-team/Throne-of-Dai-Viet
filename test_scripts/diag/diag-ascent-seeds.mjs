...
//
// Usage: node test_scripts/diag/diag-ascent-seeds.mjs [seed,seed,...] [ticks]
//        AUTO=1 node test_scripts/diag/diag-ascent-seeds.mjs …   → battles handed to the generals (roll path)
